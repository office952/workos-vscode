...
| TE2E-028 | Same-scenario / W7-T02 remaining limitations | Accepted debt | P2 | Cross-cutting | TE2E-013 | follow-up builds | Planning-minute **source** still often 0; stock G3 deferred; labor $ excluded; DETERMINISTIC_LOCAL_SCENARIO fixture; limited Letters template breadth — Wave 7 owner **ACCEPT** (2026-07-17) keeps these as accepted open residuals; **do not close** or treat as resolved | QA | open | follow-up | per-gap builds | — | W7-T03 OWNER_SIGNED · D-020 | MASTER 00 | — |
