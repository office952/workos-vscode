...
| TE2E-028 | Same-scenario / W7-T02 remaining limitations | Accepted debt | P2 | Cross-cutting | TE2E-013 | follow-up builds | **TE2E-028A DONE** (static). **TE2E-028B DONE** (Letters formula duration Aggregate→Plan PROVEN_CURRENT 2026-07-17, proof scope Letters-only one formula). Still open: stock G3 deferred; labor $ excluded; DETERMINISTIC_LOCAL_SCENARIO fixture; broader template/op formula coverage — **do not close** whole issue | QA | open | TE2E-028A/B done; residuals follow-up | per-gap builds | `/execution/972910` | W7-T03 · D-020 · TE2E-028B | MASTER 00 | — |
...
| TE2E-025 | Dual pricing path 7G/7H vs CostEngine | Risk | P2 | Calcul | — | cost authority | **Legacy `/entities/quotes/price` ISOLATED** (HTTP 410, OpenAPI absent, QuoteWizard blocked 2026-07-17). CostEngine may remain for internal simulate-cost; 7G is sole customer-offer authority on active spine | Pricing/Cost | **mitigated** | legacy isolation | retirement tests | API + QuoteWizard | — | MASTER 10 | D-010 + legacy isolation |
