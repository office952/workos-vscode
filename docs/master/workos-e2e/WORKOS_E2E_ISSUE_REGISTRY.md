...
|----|-------|-------|-----|-------|--------------|-------------------|------------|-------|--------|-----------|-----------|---------------|------------|-----------|----------------|
| TE2E-001 | Mounting blocker ignores mounting_solution | Defect | P1 | Intake V6 | — | PD, handoff, Offer | CONFIRMED legacy gate | Intake/FormSystem | **fixed** | W1-L-SPINE | pytest capture + spine tests | `/intake-v6/.../operator` step 2 Montaj | Montaj tab screenshot | PD03, MASTER 09 | W1-L-SPINE |
| TE2E-002 | ready_for_quote_preview with blockers | Defect | P1 | Intake V6 | TE2E-001 partial | Offer CTA tone | CONFIRMED readiness derive | Intake workspace | **fixed** | W1-L-SPINE | workspace readiness tests | step 2–3 | capture JSON | MASTER 04 | W1-L-SPINE |
| TE2E-003 | Finish truth not persisted | Defect | P1 | Intake V6 | — | PD, capture | CONFIRMED UI gap | Intake finish | open | W1-T02 | finish_setup persistence tests | step 2 review | capture JSON | PD02, MASTER 02 | — |
...
| TE2E-013 | Same-scenario spine absent | Risk | P2 | Cross-cutting | TE2E-001+ | final E2E | CONFIRMED no records | QA | open | W7-T01 | full spine test | quotes/orders/execution | empty states | MASTER 00 | — |
| TE2E-014 | Handoff ignores capture blockers | Defect | P1 | Intake→Ofertă | TE2E-001,002 | bad offer truth | CONFIRMED policy | Intake commercial | **fixed** | W1-L-SPINE | handoff policy tests | code path | — | MASTER 05 | W1-L-SPINE |
| TE2E-015 | merge_policy_findings unused | Defect | P2 | Intake→Ofertă | TE2E-014 | blockers not merged | CONFIRMED unwired | Intake | **fixed** | W1-L-SPINE | policy merge test | code | — | MASTER 05 | W1-L-SPINE |
