...
| TE2E-028 | Same-scenario PROVEN_V1 remaining limitations | Accepted debt | P2 | Cross-cutting | TE2E-013 | follow-up builds | Planning minutes partial; stock G3 not forced; labor $ excluded; DETERMINISTIC_LOCAL_SCENARIO fixture origin; not all templates | QA | open | follow-up | per-gap builds | — | BUILD_SAME_SCENARIO… | MASTER 00 | — |
