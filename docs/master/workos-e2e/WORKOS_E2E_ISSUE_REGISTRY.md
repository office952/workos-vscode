...
| TE2E-028 | Same-scenario / W7-T02 remaining limitations | Accepted debt | P2 | Cross-cutting | TE2E-013 | follow-up builds | **TE2E-028A DONE** (static planning minutes wire-through PROVEN_CURRENT 2026-07-17). Still open: formula ops without duration authority; stock G3 deferred; labor $ excluded; DETERMINISTIC_LOCAL_SCENARIO fixture; limited Letters template breadth — **do not close** whole issue | QA | open | TE2E-028A done; residuals follow-up | per-gap builds | `/execution/972901` | W7-T03 · D-020 · TE2E-028A | MASTER 00 | — |
