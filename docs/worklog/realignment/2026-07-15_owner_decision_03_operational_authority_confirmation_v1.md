...
**Probe:** `docs/qa/product-system-active-path-isolation-v1/app_auth_02/*.json`, `app_auth_02c_external_http_evidence.json`, worklog-uri APP-INT-01 / APP-AUTH-01/02 / OWNER-DECISION-02 / APP-AUTH-02B/C.
