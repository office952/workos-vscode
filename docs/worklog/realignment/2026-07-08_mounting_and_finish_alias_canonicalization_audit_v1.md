...
- confirmed one live Product System mismatch: frontend displayed the stale alias `TPL-VOLUMETRIC-MOUNTING-STRUCTURE_v1` although backend/runtime canonical code is `TPL-METAL-PREMOUNT-STRUCTURE_v1`
...
Risk note:
- docs and older exports still contain the stale alias `TPL-VOLUMETRIC-MOUNTING-STRUCTURE_v1`; treat that name as documentation drift unless and until a dedicated migration slice says otherwise
