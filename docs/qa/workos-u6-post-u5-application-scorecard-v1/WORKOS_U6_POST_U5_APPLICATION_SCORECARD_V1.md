# WorkOS U6 â€” Post-U5 Application Scorecard V1
...
| ---: | ---------- | ----: | -------- | --------------- | ----- | ---------------- |
| 1 | AppShell + `/dashboard` | 48 | P1 | Role-blind nav; naming collision â€œControl Towerâ€ | controller UI | **U7 shell/role nav** |
...
| 12 | Employee Mobile routes | n/a | FROZEN | Excluded | â€” | Final-final |
...
`/execution/:order_id` after U5 â€” clearest operational hierarchy for tested roles/states.

## Recommended next UI GO
**U7 â€” AppShell day-mode role navigation + single production home decision**
...
**PREEXISTING_UNRELATED** â€” reproduced only on `/execution/:orderId` preview path; not repaired in U6.
