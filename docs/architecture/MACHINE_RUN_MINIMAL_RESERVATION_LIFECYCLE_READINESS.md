...
Docs: CREATE + CONFIRM/RELEASE/CANCEL + RESCHEDULE + START/COMPLETE runtime VERIFIED in code · QA operational usage not activated · RESERVED ≠ RUNNING · RELEASE also accepts COMPLETED/RESERVED.
