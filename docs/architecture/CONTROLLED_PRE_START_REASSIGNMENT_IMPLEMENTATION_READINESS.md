...
Owner schema decisions: `REASSIGNMENT_TRANSITION_PERSISTENCE_SCHEMA_DECISIONS.md` (DEC-REASSIGN-SCHEMA-01…12).
...
Schema Owner decisions are **recorded**. Implementation remains unauthorized.
...
Do **not** start Phase A (migration/table/backfill) or reassignment commands without a separate Owner GO.
