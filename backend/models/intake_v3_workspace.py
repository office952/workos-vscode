"""ORM model for Intake V3 draft workspace persistence."""
...
class IntakeV3WorkspaceRecord(Base):
    __tablename__ = "intake_v3_workspaces"
    ...
    preview_snapshot_json = Column(Text, nullable=True)
