...
BUILD4_MATERIAL_STUBS: List[Dict[str, Any]] = [
    ...
    # --- Litere volumetrice ---
    {
        ...
        "name": "ACP / aluminiu față litere",
        "unit": "mp",
        "category": "panou_compozit",
    },
    {
        "code": "MAT-PROFIL-LATERAL-LITERE",
        "name": "Profil lateral (bordură) litere — selectează varianta după return_depth_mm",
        "unit": "ml",
        "category": "profil_metal",
    },
    {
        "code": "MAT-PROFIL-LATERAL-LITERE-30MM",
        "name": "Return/cant aluminiu 30 mm — litere volumetrice",
        "unit": "ml",
        "category": "profil_metal",
    },
    {
        "code": "MAT-PROFIL-LATERAL-LITERE-60MM",
        "name": "Return/cant aluminiu 60 mm — litere volumetrice",
        "unit": "ml",
        "category": "profil_metal",
    },
    {
        "code": "MAT-PROFIL-LATERAL-LITERE-80MM",
        "name": "Return/cant aluminiu 80 mm — litere volumetrice",
        "unit": "ml",
        "category": "profil_metal",
    },
    {
        "code": "MAT-PROFIL-LATERAL-LITERE-100MM",
        "name": "Return/cant aluminiu 100 mm — litere volumetrice",
        "unit": "ml",
        "category": "profil_metal",
    },
    {
        "code": "MAT-SPATE-PVC-LITERE",
        "name": "Forex 10 mm spate litere (cod operațional MAT-SPATE-PVC-LITERE)",
        "unit": "mp",
        "category": "forex",
    },
    {
    ...
    {
        "code": "MAT-ORACAL-641",
        "name": "Oracal 641 — Economy Cal autocolant",
        "unit": "mp",
        "category": "vinyl",
    },
    {
        "code": "MAT-ORACAL-651",
        "name": "Oracal 651 — autocolant față litere",
        "unit": "mp",
        "category": "vinyl",
    },
    {
        "code": "MAT-ORACAL-8500",
        "name": "Oracal 8500 — Translucent Cal autocolant",
        "unit": "mp",
        "category": "vinyl",
    },
    {
    ...
    },
    {
        ...
        "name": "Autocolant print + laminare față litere",
        "unit": "mp",
        "category": "vinyl",
    },
    {
    ...
    },
    {
        ...
        "name": "Sursă LED 12V litere — selectează varianta după putere (W)",
        "unit": "buc",
        "category": "iluminat_led",
    },
    {
        "code": "MAT-LED-PSU-12V-60W",
        "name": "Sursă LED 12V 60W — litere volumetrice",
        "unit": "buc",
        "category": "iluminat_led",
    },
    {
        "code": "MAT-LED-PSU-12V-100W",
        "name": "Sursă LED 12V 100W — litere volumetrice",
        "unit": "buc",
        "category": "iluminat_led",
    },
    {
        "code": "MAT-LED-PSU-12V-160W",
        "name": "Sursă LED 12V 160W — litere volumetrice",
        "unit": "buc",
        "category": "iluminat_led",
    },
    {
        "code": "MAT-LED-PSU-12V-200W",
        "name": "Sursă LED 12V 200W — litere volumetrice",
        "unit": "buc",
        "category": "iluminat_led",
    },
