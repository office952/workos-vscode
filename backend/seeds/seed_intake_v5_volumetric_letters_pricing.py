...
MATERIAL_PRICES: list[dict[str, Any]] = [
    {"code": "MAT-ACP-FATA-LITERE", "name": "plexiglas 3mm PMMA - opal", "unit": "mp", "unit_cost": 16.0, "category": "plexiglas"},
    {"code": "MAT-SPATE-PVC-LITERE", "name": "Forex 10 mm", "unit": "mp", "unit_cost": 16.0, "category": "forex"},
    {"code": "MAT-PROFIL-LATERAL-LITERE-30MM", "name": "Volum aluminiu 30 mm", "unit": "ml", "unit_cost": 2.0, "category": "profil_metal"},
    {"code": "MAT-PROFIL-LATERAL-LITERE-60MM", "name": "Volum aluminiu 60 mm", "unit": "ml", "unit_cost": 3.0, "category": "profil_metal"},
    {"code": "MAT-PROFIL-LATERAL-LITERE-80MM", "name": "Volum aluminiu 80 mm", "unit": "ml", "unit_cost": 4.0, "category": "profil_metal"},
    {"code": "MAT-PROFIL-LATERAL-LITERE-100MM", "name": "Volum aluminiu 100 mm", "unit": "ml", "unit_cost": 5.0, "category": "profil_metal"},
    {"code": "MAT-ORACAL-641", "name": "Oracal 641", "unit": "mp", "unit_cost": 6.5, "category": "vinyl"},
    {"code": "MAT-ORACAL-651", "name": "Oracal 651", "unit": "mp", "unit_cost": 9.0, "category": "vinyl"},
    {"code": "MAT-ORACAL-8500", "name": "Oracal 8500", "unit": "mp", "unit_cost": 20.0, "category": "vinyl"},
    {"code": "MAT-VINYL-PRINT", "name": "Folie autocolantă PVC — print față litere", "unit": "mp", "unit_cost": 1.5, "category": "vinyl"},
    {"code": "MAT-VINYL-PRINT-LAMINATED", "name": "Printat / Laminat", "unit": "mp", "unit_cost": 10.0, "category": "vinyl"},
    {"code": "MAT-LED-MODULE", "name": "Modul LED 12V", "unit": "buc", "unit_cost": 0.5, "category": "iluminat_led"},
    ...
    {"code": "MAT-VOPSEA-RAL-CANT-30MM", "name": "Vopsire RAL cant 30 mm - material", "unit": "ml", "unit_cost": 2.0, "category": "consumabile"},
    {"code": "MAT-VOPSEA-RAL-CANT-60MM", "name": "Vopsire RAL cant 60 mm - material", "unit": "ml", "unit_cost": 2.5, "category": "consumabile"},
    {"code": "MAT-VOPSEA-RAL-CANT-80MM", "name": "Vopsire RAL cant 80 mm - material", "unit": "ml", "unit_cost": 3.0, "category": "consumabile"},
    {"code": "MAT-VOPSEA-RAL-CANT-100MM", "name": "Vopsire RAL cant 100 mm - material", "unit": "ml", "unit_cost": 4.0, "category": "consumabile"},
...
WORKCENTER_RATES: list[dict[str, Any]] = [
    ...
    {"code": "RETURN_CANT_RAL_PAINT_LABOR", "label": "Manopera vopsit RAL pe cant", "rate": 1.0, "basis": "per_linear_meter"},
    {"code": "FACE_VINYL_APPLICATION_LABOR", "label": "Manoperă aplicare folie fețe litere", "rate": 5.0, "basis": "per_square_meter"},
    {"code": "RETURN_CANT_VINYL_APPLICATION_LABOR", "label": "Aplicare folie autocolanta pe cant", "rate": 1.0, "basis": "per_linear_meter"},
