...
OWNER_VALID_ACTIVE_TEMPLATE_CODE = "TPL-VOLUMETRIC-LETTERS_v2"
OWNER_VALID_STRUCTURE_TEMPLATE_CODE = "TPL-METAL-PREMOUNT-STRUCTURE_v1"
OWNER_VALID_ACTIVE_TEMPLATE_CODES: FrozenSet[str] = frozenset(
    {"TPL-VOLUMETRIC-LETTERS_V2", "TPL-METAL-PREMOUNT-STRUCTURE_V1"}
)
