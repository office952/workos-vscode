...
def build_gradi_logical_list_read_model_from_runtime(
    *,
    ...
    led_psu_rows = _runtime_material_rows_with_prefix(consumable_rows, "led_psu")
    ...
    rows: list[dict[str, Any]] = [
        ...
        *([
        ...
        _line(line_id="material.led_psu", display_label="Sursa LED 12V", category=CORE_CATEGORY_MATERIALS, component_code="comp_led_litere", module_code="sistem_led", formula_code="MATERIAL_PSU_BY_POWER_SAFETY_FACTOR_V1", rows=led_psu_rows, formula_status="legacy_unversioned", preferences={"required_psu_watts": required_psu, "selected_psu_watts": selected_psu, "configured_psu_capacity": configured_psu_capacity, "psu_configuration": psu_configuration}, warnings=["PSU_UNDERSIZED"] if "PSU_UNDERSIZED" in response_warnings else [], blockers=["PSU_UNDERSIZED"] if "PSU_UNDERSIZED" in response_blockers else []),
        ...
        _line(line_id="material.mounting_accessories", display_label="Consumabile producție — accesorii / conectori", category=CORE_CATEGORY_MATERIALS, component_code="comp_finisaj_litere", module_code="finisaje", formula_code="MATERIAL_MOUNTING_ACCESSORIES_BY_COST_PERCENT_V1", rows=con("mounting_accessories_percent"), formula_status="legacy_unversioned", gaps=["COMMERCIAL_FORMULA_UNVERSIONED"]),
