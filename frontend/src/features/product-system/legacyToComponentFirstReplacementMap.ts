...
export const LEGACY_TO_COMPONENT_FIRST_REPLACEMENT_MAP: LegacyReplacementMapEntry[] = [
  {
    ...
    replacementTargetLabel: "Component Template — Face",
  ...
  },
  {
    ...
    replacementTargetLabel: "Component Template — Back",
    replacementTargetType: "component_template",
    migrationTruthAreas: [
      "material spate",
      "grosime spate",
  ...
  },
  {
    ...
    replacementTargetLabel: "Component Template — LED",
    replacementTargetType: "component_template",
    migrationTruthAreas: [
      "tip LED",
      "densitate LED",
  ...
  },
  {
    ...
    replacementTargetLabel: "Component Template — Return/Cant",
    replacementTargetType: "component_template",
    migrationTruthAreas: [
      "cant stock",
      "Oracal",
  ...
  },
  {
    ...
    replacementTargetLabel: "Component Template — Finish",
    replacementTargetType: "component_template",
  ...
  },
  {
    ...
    replacementTargetLabel: "Component Template — Mounting",
    replacementTargetType: "component_template",
    migrationTruthAreas: [
      "montaj",
      "șablon",
  ...
  },
  {
    ...
    replacementTargetLabel: "Product Composer (candidate only)",
    replacementTargetType: "product_composer",
    migrationTruthAreas: ["product orchestration only — not material truth"],
    missingTruthAreas: ["full component-first truth stack", "runtime activation", "Work Intake cutover"],
...
export function getLegacyReplacementEntry(legacyCode: string): LegacyReplacementMapEntry | null {
  ...
  return (
    LEGACY_TO_COMPONENT_FIRST_REPLACEMENT_MAP.find(
...
export function resolveLegacyReplacementEntry(legacyCode: string): LegacyReplacementMapEntry {
  ...
  return {
    ...
    ownerNoteRo:
      "Nu șterge acum. Modulul legacy nu are încă mapping aprobat către component-first.",
  };
}

export function buildLegacyReplacementSummary(
  entries: LegacyReplacementMapEntry[] = LEGACY_TO_COMPONENT_FIRST_REPLACEMENT_MAP,
...
export const COMPONENT_FIRST_REPLACEMENT_CONTEXT = [
  {
