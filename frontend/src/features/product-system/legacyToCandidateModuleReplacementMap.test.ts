...
describe("legacyToCandidateModuleReplacementMap", () => {
  it("maps core legacy modules to candidate-module targets with canDeleteNow=false", () => {
    ...
    for (const entry of LEGACY_TO_CANDIDATE_MODULE_REPLACEMENT_MAP) {
