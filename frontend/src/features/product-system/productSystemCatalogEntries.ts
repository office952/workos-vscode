...
export const UNIFIED_CATALOG_FILTERS: Array<{
  ...
  { id: "candidate-module-sets", label: "Seturi Module produs (candidate)", testId: "product-system-filter-candidate-module-sets" },
  { id: "legacy-modules", label: "Module produs legacy", testId: "product-system-filter-legacy-modules" },
...
export const UNIFIED_CATALOG_BUCKETS: Array<{
  ...
  {
    id: "candidate-module-sets",
    label: "Seturi Module produs (candidate)",
    description: "Inspectare readonly — Product Template + Module produs egale; fără activare sau Work Intake.",
    testId: "product-system-catalog-bucket-candidate-module-sets",
    toggleTestId: "product-system-catalog-bucket-toggle-candidate-module-sets",
    defaultExpanded: false,
    order: 3,
  },
  {
    id: "legacy-shared-modules",
    label: "Module produs legacy partajate",
    description: "Module produs legacy folosite de Product Template părinte — nu set candidat nou.",
  ...
  },
  {
    ...
    description: "Product Template-uri retrase din fluxul curent de ofertare.",
