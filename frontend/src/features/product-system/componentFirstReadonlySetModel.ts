...
export type ComponentFirstReadonlyComponent = {
  templateCode: string;
  componentId: string;
  roleLabel: string;
...
export type ComponentFirstReadonlySetModel = {
...
export function buildFallbackComponentFirstReadonlySetModel(
  selectedTemplateCode: string,
...
export function buildComponentFirstReadonlySetModel(
