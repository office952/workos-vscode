...
export const RETURN_CANT_WORKSHOP_FIELDS: ComponentTruthField[] = [
  ...
  field({
    ...
    ownerQuestionRo:
      "Care este lista codurilor Oracal pe care vrei să le avem în selector și au toate același preț sau preț diferit?",
    notesRo: "Selector Oracal frumos — lista și prețurile trebuie confirmate de owner.",
    mustNotInvent: true,
  }),
  field({
    fieldKey: "ral_code",
    ...
    inputType: "text",
    status: "owner_input_required",
    ownerQuestionRo: "Vrei RAL ca text liber sau selector? Există listă standard?",
    notesRo: "Model RAL pe cant: material + manoperă separate — aceeași terminologie peste tot.",
    mustNotInvent: true,
  }),
  field({
    ...
    unit: "mm",
    status: "owner_input_required",
    ownerQuestionRo: "Care sunt adâncimile standard pentru cant litere: 30 mm, 60 mm, 80 mm, altceva?",
    notesRo: "Adâncimea volumului cant — valori standard de confirmat.",
    mustNotInvent: true,
  }),
  field({
    ...
    status: "owner_input_required",
    ownerQuestionRo:
      "Ce materiale de cant folosim real: aluminiu, PVC, altceva? Le tratăm separat pentru 30/60 mm?",
    notesRo: "Material cant — fără valori implicite până la confirmare owner.",
    mustNotInvent: true,
  }),
  field({
    ...
    status: "owner_input_required",
    ownerQuestionRo: "Materialul cantului se calculează pe ml, mp, bucată, sau altă unitate?",
    notesRo: "Unitate material — decizie owner, nu presupunere.",
    mustNotInvent: true,
  }),
  field({
    ...
    status: "owner_input_required",
    ownerQuestionRo: "Manopera pentru cant se calculează pe ml, bucată, set, mp sau altfel?",
    notesRo: "Unitate manoperă — decizie owner.",
    mustNotInvent: true,
  }),
  field({
    ...
    status: "owner_input_required",
    ownerQuestionRo: "Pentru Vopsit RAL pe cant, ce prețuri material folosim pentru 30 mm și 60 mm?",
    notesRo: "Placeholder formulă — fără preț inventat în acest task.",
    mustNotInvent: true,
  }),
  field({
    ...
    status: "owner_input_required",
    ownerQuestionRo:
      "Pentru Vopsit RAL pe cant, manopera se calculează cum: pe ml, pe set, pe piesă, cu minim?",
    notesRo: "Material și manoperă RAL separate — reguli de confirmat.",
    mustNotInvent: true,
  }),
  field({
