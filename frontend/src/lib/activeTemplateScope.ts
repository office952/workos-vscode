...
export const OWNER_VALID_STRUCTURE_TEMPLATE_CODE = "TPL-METAL-PREMOUNT-STRUCTURE_v1";
export const OWNER_VALID_VOLUM_ALUMINUM_TEMPLATE_CODE = "TPL-VOLUM-ALUMINIU_v1";

export const OWNER_VALID_ACTIVE_TEMPLATE_CODES = [
  OWNER_VALID_ACTIVE_TEMPLATE_CODE,
  OWNER_VALID_STRUCTURE_TEMPLATE_CODE,
  OWNER_VALID_VOLUM_ALUMINUM_TEMPLATE_CODE,
] as const;
