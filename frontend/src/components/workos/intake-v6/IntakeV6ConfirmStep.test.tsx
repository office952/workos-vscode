...
describe("IntakeV6ConfirmStep", () => {
  ...
  it("shows owner-facing summary labels with legacy page title collapsed by default", async () => {
    ...
    expect(
      within(screen.getByTestId("intake-v6-step-confirm")).getByRole("heading", {
        level: 2,
        name: "Confirmare finală",
      }),
    ).toBeInTheDocument();
