...
export const REVIEW_SELECT_CLASS =
  "h-7 w-full rounded border border-wo-border-strong bg-wo-surface-inset px-2 py-0.5 text-[11px]";
...
export const REVIEW_COLOR_ROW_SHELL_CLASS = "min-w-0 border-t border-wo-border-strong/50 pt-1.5";

export const REVIEW_FACE_COLUMN_CLASS =
  "min-w-0 sm:border-r sm:border-wo-border-strong/70 sm:pr-2";
