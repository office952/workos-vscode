      ...
      <div className="space-y-3" data-testid="intake-v6-segmented-electrical-panels">
        {electrical.panels.map((panel) => {
          ...
          return (
            <div
              key={panel.panel_id}
              className="rounded border border-[#2A3548] bg-[#0A0F1A]/80 px-2.5 py-2 space-y-2"
            ...
            >
              ...
              <label className="block text-[10px] text-slate-400">
                Sursa 220V
                <select
                  className="mt-0.5 w-full rounded border border-[#2A3548] bg-[#0B1220] px-2 py-1 text-[11px] text-slate-100"
