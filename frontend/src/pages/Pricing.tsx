...
import { StatusBadge, chromeBanner } from "@/components/workos/design-system";
      ...
      <div className="relative w-full max-w-lg bg-wo-surface-inset border-l border-border overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-wo-surface-inset border-b border-border px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Settings2 className="w-5 h-5 text-wo-info" />
        ...
        <div className="px-6 py-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-wo-surface-raised border border-wo-border-strong rounded-lg p-3 text-center">
              <p className="text-[18px] font-bold text-wo-success">{grouped.active.length}</p>
          ...
          <div className={`rounded-lg p-3 ${chromeBanner.warning}`}>
          ...
          <div className="bg-wo-surface-raised border border-wo-border-strong rounded-lg p-3">
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              <Info className="w-3 h-3 inline mr-1 text-wo-info" />
      ...
      <div className="relative w-full max-w-xl bg-wo-surface-inset border-l border-border overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-wo-surface-inset border-b border-border px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-[12px] font-mono text-wo-info mt-0.5">{material.code}</p>
          </div>
          <button onClick={onClose} className="p-1.5 rounded-md hover:bg-muted transition-colors">
            <X className="w-4 h-4 text-muted-foreground" />
          </button>
        ...
        <div className="px-6 py-4 space-y-5">
              ...
              <div className="col-span-2">
                ...
                {material.source_url && (
                  <a
                    ...
                    className="text-[11px] text-wo-info hover:underline mt-0.5 inline-block"
                  >
                    {material.source_url}
                  </a>
                )}
          ...
          <div className="bg-wo-surface-raised border border-wo-border-strong border-t-2 border-t-blue-500 rounded-lg p-4">
            ...
            {estimated.value !== null ? (
              <p className="text-[20px] font-bold text-wo-info">
              ...
              <p className="text-[13px] text-wo-warning">Indisponibil — {estimated.reason}</p>
            )}
            ...
            <div className="bg-wo-surface-raised border border-wo-border-strong rounded-lg p-4">
              ...
              <div className="space-y-2 text-[12px]">
                ...
                <div className="flex justify-between border-t border-wo-border-strong pt-2">
                  ...
                  <span className="text-wo-info font-bold">{fmtCost(dryRunResult.commercial_unit_price, dryRunResult.currency)}</span>
                </div>
                {dryRunResult.warnings.length > 0 && (
                  <div className="mt-2 space-y-1">
                    {dryRunResult.warnings.map((w, i) => (
                      <p key={i} className="text-[11px] text-wo-warning flex items-start gap-1">
    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-xl bg-wo-surface-inset border-l border-border overflow-y-auto">
        ...
        <div className="px-6 py-4 space-y-4">
          <div className={`rounded-lg p-3 text-[11px] leading-relaxed ${chromeBanner.warning}`}>
          ...
          <div className="flex gap-2">
            <button
              onClick={handleSave}
              disabled={saving}
              className="inline-flex items-center gap-1.5 px-4 py-2 text-[12px] font-semibold rounded-md border border-wo-info/40 bg-wo-info-muted text-wo-info hover:bg-wo-hover disabled:opacity-50"
            >
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 text-[12px] rounded-md border border-wo-border-strong bg-wo-surface-raised text-wo-text-secondary hover:bg-wo-hover"
            >
              Anulează
            </button>
          </div>
