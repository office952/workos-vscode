/**
 * One-off screenshot capture for COMPONENT_FIRST_LETTERS_CARD_BASED_UI_RESTRUCTURE_READONLY_V1
...
const outDir = path.resolve(
  __dirname,
  "../../docs/qa/component-first-card-ui-restructure-2026-07-09/screenshots",
);
...
async function main() {
  ...
  await page.waitForSelector('[data-testid="product-system-component-first-letters-set"]', { timeout: 30_000 });
  ...
  await page.waitForSelector('[data-testid="product-system-component-first-components-list"]', { timeout: 15_000 });
  ...
  await page.waitForSelector('[data-testid="product-system-component-first-settings-sheet"]', { timeout: 15_000 });
  ...
  await page
    .getByTestId("product-system-component-first-view-component-settings-TPL-COMP-LETTER-FACE_v1")
    .click();
  await page.waitForSelector('[data-testid="product-system-component-first-settings-sheet"]', { timeout: 15_000 });
  ...
  await page.waitForSelector('[data-testid="product-system-component-first-dossier-workspace"]', { timeout: 15_000 });
  await shot(page, "07_dossier_workspace");

  await page.getByTestId("product-system-component-first-dossier-focus-TPL-COMP-LETTER-FACE_v1").click();
  ...
  await page.waitForSelector('[data-testid="product-system-component-first-drift-guard"]', { timeout: 15_000 });
