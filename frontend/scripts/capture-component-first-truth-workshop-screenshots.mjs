...
const OUT = path.resolve(__dirname, "../../docs/qa/component-first-letters-product-truth-workshop-v1/screenshots");
...
await shot(page, "01_component_first_workshop_entry");
